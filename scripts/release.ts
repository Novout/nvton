...
// TODO: vitest release.ts. Switch to generi https://github.com/betterwrite/generi
...
try {
	...
	console.log(
		'New release is ready, waiting for conformation at https://github.com/vitest-dev/vitest/actions'
	);
} catch (err) {
	console.error(err);
}
